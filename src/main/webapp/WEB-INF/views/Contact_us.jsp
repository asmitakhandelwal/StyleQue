...
<meta charset="ISO-8859-1">
 ...
 <div class="page-header">
    <h1><img src=".\resources\images\logo.png" class="img-responsive" style="width:1%" alt="Image"></h1></div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1>Contact form</h1>
                    ...
                    <p class="lead">We'll get back to you within 2 working days</p>

                    
                    <form><form id="contact-form" method="post" action="contact.php" role="form"></form>
